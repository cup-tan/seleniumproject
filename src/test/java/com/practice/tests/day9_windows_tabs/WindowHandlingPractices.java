package com.practice.tests.day9_windows_tabs;
...
public class WindowHandlingPractices {
    ...
    public void p5_handling_windows(){
       ...
       String mainHandle= driver.getWindowHandle();
        System.out.println("mainHandle = " + mainHandle);//mainHandle = CDwindow-BF1C6DB691B1C73222D15E05D085D336 random number
        ...
        //Getting the current title(actual) title, and comparing with expected title.
...
//                                        changing object type --> casting
        //THIS LINE IS BASICALLY : We are down-casting our driver type to JavaScriptExecutor
