package com.practice.tests.day4_findElements_checkboxes_radio;
...
public class P1_CybertekForgotPassword {
    public static void main(String[] args) {
       ...
       // WebElement homeLink = driver.findElement(By.xpath("//a[@href='/']"));
        ...
        //Using css selector to locate this botton
        ...
        if (homeLink.isDisplayed() && retrievePasswordButton.isDisplayed() && header.isDisplayed()
        && emailLabel.isDisplayed() && emailInbox.isDisplayed() && poweredByDiv.isDisplayed()){
