package com.practice.tests.day13_pom_synchronization;
...
public class NegativeLoginTests_SB {
    ...
    public void negative_login_test1() {
        ...
        //#2- Call the object to use the wen elements
        // Entering incorrect username
        loginPage.usernameInput.sendKeys("asdsffd");
    ...
    public void negative_login_test2() {
        String url = ConfigurationReader.getProperty("samarbearUrl");
        Driver.getDriver().get(url);
